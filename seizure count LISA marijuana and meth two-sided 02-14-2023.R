...
# write.csv(relative.MoransI, "marijuana counts KNN5 R codes 999 two-sided (relative).csv", row.names=F)
...
# write.csv(absolute.b1.MoransI, "marijuana counts KNN5 R codes 999 two-sided (absolute base 1).csv", row.names=F)
...
# write.csv(absolute.t1.MoransI, "marijuana counts KNN5 R codes 999 two-sided (absolute base t_1).csv", row.names=F)

# marijuana Plots
LISA.rel <- read.csv("marijuana counts KNN5 R codes 999 two-sided (relative).csv") %>% as_tibble
LISA.abs.1 <- read.csv("marijuana counts KNN5 R codes 999 two-sided (absolute base 1).csv") %>% as_tibble
LISA.abs.t_1 <- read.csv("marijuana counts KNN5 R codes 999 two-sided (absolute base t_1).csv") %>% as_tibble
...
# ggsave(paste("marijuana  n_HL annual.jpg", sep=""), n_HL_map, width=20, height=15, units="cm")
...
# ggsave(paste("marijuana  n_HL 2018-2021.jpg", sep=""), n_HL_map_all, width=20, height=15, units="cm")
...
# write.csv(relative.MoransI, "meth counts KNN5 R codes 999 two-sided (relative).csv", row.names=F)
...
# write.csv(absolute.b1.MoransI, "meth counts KNN5 R codes 999 two-sided (absolute base 1).csv", row.names=F)
...
# write.csv(absolute.t1.MoransI, "meth counts KNN5 R codes 999 two-sided (absolute base t_1).csv", row.names=F)

# meth Plots
LISA.rel <- read.csv("meth counts KNN5 R codes 999 two-sided (relative).csv") %>% as_tibble
LISA.abs.1 <- read.csv("meth counts KNN5 R codes 999 two-sided (absolute base 1).csv") %>% as_tibble
LISA.abs.t_1 <- read.csv("meth counts KNN5 R codes 999 two-sided (absolute base t_1).csv") %>% as_tibble
...
LISA_n_HL.map %>% pivot_longer(-c(long, lat, group, GEOID, state, county, n_HL_All), names_to="year", values_to="n_HL_year") %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) -> n_HL_map
# ggsave(paste("meth  n_HL annual.jpg", sep=""), n_HL_map, width=20, height=15, units="cm")
...
LISA_n_HL.map %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) -> n_HL_map_all
# ggsave(paste("meth  n_HL 2018-2021.jpg", sep=""), n_HL_map_all, width=20, height=15, units="cm")
