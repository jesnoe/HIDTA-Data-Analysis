...
# write.csv(relative.MoransI, "marijuana counts KNN5 R codes 999 upper tail relative (02-21-2023).csv", row.names=F)
...
# write.csv(absolute.b1.MoransI, "marijuana counts KNN5 R codes 999 upper tail absolute base_1 (02-21-2023).csv", row.names=F)
...
# write.csv(absolute.t1.MoransI, "marijuana counts KNN5 R codes 999 upper tail absolute base_t1 (02-21-2023).csv", row.names=F)

# marijuana Plots
LISA.rel <- read.csv("marijuana counts KNN5 R codes 999 upper tail relative (02-21-2023).csv") %>% as_tibble
LISA.abs.1 <- read.csv("marijuana counts KNN5 R codes 999 upper tail absolute base_1 (02-21-2023).csv") %>% as_tibble
LISA.abs.t_1 <- read.csv("marijuana counts KNN5 R codes 999 upper tail absolute base_t1 (02-21-2023).csv") %>% as_tibble
...
# ggsave("marijuana n_HH annual (rel).jpg", n_HH_map, width=20, height=15, units="cm")
...
# ggsave("marijuana n_HH 2018-2021 (rel).jpg", n_HH_map_all, width=20, height=15, units="cm")
...
# write.csv(relative.MoransI, "meth counts KNN5 R codes 999 upper tail relative (02-21-2023).csv", row.names=F)
...
# write.csv(absolute.b1.MoransI, "meth counts KNN5 R codes 999 upper tail absolute base_1 (02-21-2023).csv", row.names=F)
...
# write.csv(absolute.t1.MoransI, "meth counts KNN5 R codes 999 upper tail absolute base_t1 (02-21-2023).csv", row.names=F)

# meth Plots
LISA.rel <- read.csv("meth counts KNN5 R codes 999 upper tail relative (02-21-2023).csv") %>% as_tibble
LISA.abs.1 <- read.csv("meth counts KNN5 R codes 999 upper tail absolute base_1 (02-21-2023).csv") %>% as_tibble
LISA.abs.t_1 <- read.csv("meth counts KNN5 R codes 999 upper tail absolute base_t1 (02-21-2023).csv") %>% as_tibble
...
LISA_n_HH.map %>% pivot_longer(-c(long, lat, group, GEOID, state, county, n_HH_All), names_to="year", values_to="n_HH_year") %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) -> n_HH_map
# ggsave("meth n_HH annual (rel).jpg", n_HH_map, width=20, height=15, units="cm")
...
LISA_n_HH.map %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) -> n_HH_map_all
# ggsave("meth n_HH 2018-2021 (rel).jpg", n_HH_map_all, width=20, height=15, units="cm")
